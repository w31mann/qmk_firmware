...
#define _OLED_HEIGHT        (OLED_DISPLAY_HEIGHT - 1 - TOP_OFFSET)
...
#endif
#define _MATRIX_X           0
#define _MATRIX_Y           (_OLED_HEIGHT - _MATRIX_HEIGHT + 1 + TOP_OFFSET)
...
#define _AXIS_HEIGHT        _OLED_HEIGHT + TOP_OFFSET
